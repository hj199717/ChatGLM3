# -*-coding:utf-8 -*-
'''
File       : chatglm_document_qa.py
Time       : 2023/12/13 15:44
Author     : He Jia
version    : 1.0.0
Description: 
'''
...
from ChatGLM3copy import ChatGLM3
import os
import gradio as gr
...
MODEL_PATH = os.environ.get('MODEL_PATH', '/opt/project/hejia/ChatGLM3/THUDM/chatglm3-6b')
llm = ChatGLM3()
